  ...
  return (
    ...
    <section className={quickActionStyles.quickActions}>
      <div>
        ...
        <span>Add a farm cost with its payment, receipt, and related records.</span>
      </div>
        ...
        <div className={styles.modalBackdrop} data-ui-backdrop="true" role="presentation">
          <section aria-label="Record investment" aria-modal="true" className={styles.modal} data-ui-modal="true" role="dialog">
            ...
            <form className={styles.modalForm} onSubmit={handleSubmit}>
              ...
              <div className={styles.modalColumns}><label>Amount<input name="amount" min="0.01" placeholder="e.g. 2500.00" required step="0.01" type="number" /></label><CalendarField label="Expense date" name="expense_date" /></div>
              ...
              {expenseType === "Recurring expense" ? <><div className={styles.modalColumns}><label>Frequency<select name="frequency" required><option>Weekly</option><option>Monthly</option><option>Quarterly</option><option>Yearly</option></select></label><CalendarField label="Next due date" name="next_due_date" required /></div><CalendarField label="End date" name="end_date" /></> : null}
